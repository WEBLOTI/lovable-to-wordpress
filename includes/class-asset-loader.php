...
class Lovable_Asset_Loader {
    ...
    public function preload_assets() {
        ?>
        <link rel="preload" href="<?php echo LOVABLE_EXPORTER_PLUGIN_URL; ?>assets/css/lovable.css" as="style">
        <link rel="preload" href="<?php echo LOVABLE_EXPORTER_PLUGIN_URL; ?>assets/js/lovable-animations.js" as="script">
        <?php
    }
    ...
    private function get_critical_css() {
        $critical_css_file = LOVABLE_EXPORTER_PLUGIN_DIR . 'assets/css/critical.css';
